...
#ifndef __IMX8MP_TRUX_H
#define __IMX8MP_TRUX_H
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"findfdt=" \
		"if test $fdt_file = undefined; then " \
			"if test $board_name = TRUX-SOM-MX8M-PLUS; then " \
				"setenv fdt_file imx8mp-trux-som-symphony.dtb; " \
			"else " \
				"if test $trux_carrier_rev = legacy; then " \
					"setenv fdt_file imx8mp-trux-8MDVP-legacy.dtb;" \
				"else " \
					"setenv fdt_file imx8mp-trux-8MDVP.dtb;" \
				"fi; " \
			"fi; " \
		"fi; \0" \
	"loadfdt=run findfdt; " \
